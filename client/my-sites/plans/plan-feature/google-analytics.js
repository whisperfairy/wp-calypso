				...
				<g mask="url(#b)">
					<g transform="translate(-24 -22)">
						<g transform="translate(0 61)">
							...
							<use xlinkHref="#c"/>
							<g mask="url(#d)" fill-opacity=".05" fill="#44B963">
						...
						<path d="M4.958 159.457l64.13 10.647 64.447-30.737 63.947 15.8 62.526-45.334 64.804-26.5 64.646 12.724 63.263 35.09 64.463-21.06 64.15-45.218 64.178 18.397 63.95 52.7 64.12 23.122" stroke-opacity=".12" stroke="#44B963" stroke-width="4"/>
						<path d="M3.958 156.457l64.13 10.647 64.447-30.737 63.947 15.8 62.526-45.334 64.804-26.5 64.646 12.724 63.263 35.09 64.463-21.06 64.15-45.218 64.178 18.397 63.95 52.7 64.12 23.122v50.48H.48" stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill-opacity=".05" fill="#44B963"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="68" cy="167" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="132" cy="137" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="196" cy="152" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="259" cy="107" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="324" cy="80" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="388" cy="93" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="452" cy="128" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="516" cy="107" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="580" cy="62" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="644" cy="80" r="4"/>
						<circle stroke-opacity=".62" stroke="#44B963" stroke-width="2" fill="#FFF" cx="708" cy="133" r="4"/>
					</g>
					<path d="M541 6.005c0-1.107.888-2.005 2-2.005h35c1.104 0 2 .897 2 2.005v19.99A1.997 1.997 0 0 1 578 28h-13.657l-4.053 3-4.018-3h-13.275A2 2 0 0 1 541 25.995V6.005z" fill-opacity=".27" fill="#C8D7E1"/>
					...
					<text font-family="AppleColorEmoji, Apple Color Emoji" font-size="14" fill="#000" transform="translate(537)">
