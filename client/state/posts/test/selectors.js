...
describe( 'selectors', () => {
	...
	describe( 'isEditedPostContentEmpty()', () => {
		it( 'should return true if new post without title or content', () => {
		...
		it( 'should return false if new post with title', () => {
			const isEmpty = isEditedPostContentEmpty( {
				posts: {
					edits: {
						2916284: {
		...
		it( 'should return false if new post with content', () => {
			const isEmpty = isEditedPostContentEmpty( {
				posts: {
					edits: {
						2916284: {
		...
		it( 'should return true if saved post has content but edits remove', () => {
			const isEmpty = isEditedPostContentEmpty( {
				posts: {
					items: {
						'3d097cb7c5473c169bba0eb8e3c6cb64': { ID: 841, site_ID: 2916284, global_ID: '3d097cb7c5473c169bba0eb8e3c6cb64', title: 'Hello World' }
